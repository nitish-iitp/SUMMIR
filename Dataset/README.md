...
This directory contains the curated datasets used for training and evaluating the SUMMIR (Sentence Unified Multimetric Model for Importance Ranking) framework.
...
with open('Dataset/Soccer/datasetsoccer1.jsonl', 'r') as f:
    for line in f:
